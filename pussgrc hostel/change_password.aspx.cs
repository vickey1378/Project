...
public partial class change_password : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        da = new SqlDataAdapter("select password from vorden where password='" + txtcp.Text + "'", con);
        ...
        if (dt.Rows.Count.ToString() == "1")
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update vorden set password='" + txtcpwd.Text + "' where login_id='" +s+"'and password='"+ txtcp.Text + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
