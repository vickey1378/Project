                        ...
                        <table border="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="ConfirmNewPasswordRequired" runat="server" ControlToValidate="txtcpwd"
                            ...
                            <tr>
                                ...
                                <td style="height: 2px">
                                   ...
                                   &nbsp;<asp:Button ID="Button2" runat="server" CssClass="ver11" CausesValidation="False"
                                        Text="Back" BackColor="#660033" ForeColor="White" Height="28px" PostBackUrl="~/login.aspx" OnClick="Button2_Click" />
                                </td>

                            </tr>
                               <tr>
                                    <td style="width: 271px"><asp:Label ID="lb" runat="server"></asp:Label></td>
                            </tr>
